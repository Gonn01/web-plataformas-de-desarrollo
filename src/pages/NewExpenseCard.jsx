...
export default function NewExpenseCard({ onClose, onSave }) {
  ...
  return (
    <div className="rounded-xl bg-[#111714] border border-[#29382f]">
      {/* Header */}
      <header className="flex items-center justify-between border-b border-b-[#29382f] px-6 py-4">
        <div className="flex items-center gap-3 text-white">
          ...
          <h2 className="text-white text-lg font-bold tracking-[-0.015em]">Nuevo Gasto</h2>
        </div>
        <button
          type="button"
          onClick={onClose}
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <label className="flex flex-col">
            <p className="text-white text-sm font-medium pb-2">Entidad financiera</p>
            <input
              className="form-input h-12 w-full rounded-lg border border-[#3d5245] bg-[#1c2620] p-[15px] text-base text-white placeholder:text-[#9eb7a8] focus:border-primary focus:ring-2 focus:ring-primary/40"
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <label className="flex flex-col">
              <p className="text-white text-sm font-medium pb-2">Cantidad de Cuotas</p>
              <input
            ...
            <label className="flex flex-col">
              <p className="text-sm font-medium pb-2 text-gray-500">Cuotas Pagadas</p>
              <input
          ...
          <div>
            ...
            <div className="w-full bg-[#29382f] rounded-full h-2.5">
              <div className="bg-primary h-2.5 rounded-full" style={{ width: `${progressPct}%` }} />
            </div>
        ...
        <div>
          <label className="flex items-center justify-between cursor-pointer">
            <div>
              <p className="text-white text-sm font-medium">Ignorar en el balance</p>
              <p className="text-xs text-[#9eb7a8]">Excluye este gasto de los cálculos totales.</p>
            </div>
      ...
      {/* Footer */}
      <footer className="flex items-center justify-end gap-3 border-t border-t-[#29382f] px-6 py-4">
        <button
          type="button"
          onClick={onClose}
